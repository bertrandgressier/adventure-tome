      ...
      <main className="relative flex min-h-screen flex-col items-center justify-center p-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-md w-full space-y-8">
          ...
          <div className="space-y-4">
            <Link
              href="/characters"
              className="block w-full bg-primary hover:bg-primary/90 text-background font-[var(--font-uncial)] font-bold tracking-wider py-4 px-8 rounded-lg transition-all duration-300 shadow-lg hover:shadow-[0_0_20px_rgba(255,191,0,0.6)] hover:scale-[1.02] active:scale-[0.98] text-center text-lg border-2 border-primary"
            >
