...
describe('Migration des données - Compatibilité', () => {
  ...
  it('devrait initialiser l\'expérience à 0 pour Tome 3+ (migration v12)', () => {
    // Données v11 (avant migration v12)
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const v11Data: any = {
      id: 'v12-test-123',
    ...
    const migratedData = migrateCharacter(v11Data);
    const character = Character.fromData(migratedData);
  ...
  it('devrait initialiser l\'expérience à null pour Tome 1-2 (migration v12)', () => {
    // Données v11 pour Tome 1
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const v11DataTome1: any = {
      id: 'v12-tome1-123',
    ...
    const migratedDataTome1 = migrateCharacter(v11DataTome1);
    ...
    expect(statsTome1.experience).toBeUndefined();

    // Test avec Tome 2
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const v11DataTome2: any = { ...v11DataTome1, id: 'v12-tome2-123', book: 2, name: 'Personnage Tome 2' };
  ...
  it('devrait préserver l\'expérience existante lors de la migration v12', () => {
    // Données v12 avec expérience déjà définie
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const v12Data: any = {
      id: 'v12-preserve-123',
      name: 'Personnage avec expérience',
      book: 3,
      talent: 'instinct',
      gameMode: 'mortal',
      version: 12,
    ...
    // VÉRIFICATION: Version inchangée (déjà v12 → v13)
    expect(character.version).toBe(13);
  ...
  it('devrait initialiser l\'état et le statut à leurs valeurs par défaut pour Tome 3+ (migration v13)', () => {
    // Données v12 (avant migration v13)
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const v12Data: any = {
      id: 'v13-test-123',
      name: 'Personnage Tome 3',
  ...
  it('devrait initialiser l\'état et le statut à null pour Tome 1-2 (migration v13)', () => {
    // Données v12 pour Tome 1
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const v12DataTome1: any = {
      id: 'v13-tome1-123',
      name: 'Personnage Tome 1',
      book: 1,
      talent: 'instinct',
    ...
    const migratedDataTome1 = migrateCharacter(v12DataTome1);
    const characterTome1 = Character.fromData(migratedDataTome1);
    ...
    // Test avec Tome 2
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const v12DataTome2: any = { ...v12DataTome1, id: 'v13-tome2-123', book: 2, name: 'Personnage Tome 2' };
    const migratedDataTome2 = migrateCharacter(v12DataTome2);
    const characterTome2 = Character.fromData(migratedDataTome2);
  ...
  it('devrait préserver l\'état et le statut existants lors de la migration v13', () => {
    // Données v13 avec état et statut déjà définis
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const v13Data: any = {
      id: 'v13-preserve-123',
